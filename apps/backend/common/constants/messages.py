...
RESUME_MESSAGES = {
    "LIST_SUCCESS": "Resumes retrieved successfully.",
    "DETAIL_SUCCESS": "Resume retrieved successfully.",
    "CREATE_SUCCESS": "Resume created successfully.",
    "UPDATE_SUCCESS": "Resume updated successfully.",
    "AUTOSAVE_SUCCESS": "Resume autosaved successfully.",
    "VERSION_CREATED": "Resume version created successfully.",
    "VERSIONS_LIST_SUCCESS": "Resume versions retrieved successfully.",
    "VERSION_DETAIL_SUCCESS": "Resume version retrieved successfully.",
    "VERSION_RESTORED": "Resume version restored successfully.",
    "UPLOAD_LIST_SUCCESS": "Resume uploads retrieved successfully.",
    "UPLOAD_CREATE_SUCCESS": "Resume file uploaded successfully.",
    "UPLOAD_PARSE_SUCCESS": "Resume file parsed successfully.",
    "UPLOAD_PARSED_APPLY_SUCCESS": "Parsed resume content applied successfully.",
}


JOB_MESSAGES = {
    "LIST_SUCCESS": "Job descriptions retrieved successfully.",
    "DETAIL_SUCCESS": "Job description retrieved successfully.",
    "CREATE_SUCCESS": "Job description created successfully.",
    "UPDATE_SUCCESS": "Job description updated successfully.",
    "DELETE_SUCCESS": "Job description deleted successfully.",
}
